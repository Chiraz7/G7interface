...
using namespace G7interface;
void G7interface::FicheCommande::set_adresse_list(DataTable^ ds)
{
...
void G7interface::FicheCommande::set_article_list(DataTable^ ds)
{
    dataGridView1->DataSource = ds;
}

System::Collections::Generic::List<Composant::Choisir^>^ G7interface::FicheCommande::get_choix()
{
...
void G7interface::FicheCommande::set_commande(Composant::Commande^ d)
{
...
void G7interface::FicheCommande::set_client(String^ d)
{
    this->lblclient->Text = d;
}

void G7interface::FicheCommande::set_choix(System::Collections::Generic::List<Composant::Choisir^>^ l)
{
...
Composant::Commande^ G7interface::FicheCommande::get_commande()
{
...
System::Void G7interface::FicheCommande::button2_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void G7interface::FicheCommande::FicheCommande_Load(System::Object^ sender, System::EventArgs^ e)
{
...
bool G7interface::FicheCommande::existinarticle(String^ f)
{
    for (size_t i = 0; i < listearticle->Rows->Count; i++)
    {
...
int G7interface::FicheCommande::getartindex(String^ s)
{
    for (size_t i = 0; i < listearticle->Rows->Count; i++)
    {
...
int G7interface::FicheCommande::getartindex(int s)
{
    for (size_t i = 0; i < listearticle->Rows->Count; i++)
    {
...
System::Void G7interface::FicheCommande::button1_Click(System::Object^ sender, System::EventArgs^ e)
{
...
System::Void G7interface::FicheCommande::textBox4_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e)
{
...
System::Void G7interface::FicheCommande::button4_Click(System::Object^ sender, System::EventArgs^ e)
{
    this->Close();
}
