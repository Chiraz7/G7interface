...
namespace Composant {
    ...
    {
        return "select id_personnel,nom_p,prenom_p,date_d_embauche,id_personnel_supervise,id_adresse from [Personnel]";
    }

    String^ Personnel::SELECTbyid()
    {
        return "select id_personnel,nom_p,prenom_p,date_d_embauche,id_personnel_supervise,id_adresse from [Personnel] where id_personnel = " + this->get_id();
    }

    String^ Composant::Personnel::INSERT()
    {
        return "INSERT INTO Personnel(Nom_P, Prenom_P, Date_d_embauche,id_personnel_supervise,id_adresse)" +
    ...
    {
        return "UPDATE Personnel SET Nom_P = '" + this->nom + "', Prenom_P = '" + this->prenom + "', Date_d_embauche = convert(datetime,'" + date_to_string(this->date_dembauche) +
    ...
    {
        return "UPDATE Personnel " + "SET Nom_P = '" + this->get_nom() + "', Prenom_P = '" + this->get_prenom() + "', Date_d_embauche = " + date_to_string(this->get_date_embauche()) + ",id_personnel_Supervise = " + this->get_id_superieur() +
